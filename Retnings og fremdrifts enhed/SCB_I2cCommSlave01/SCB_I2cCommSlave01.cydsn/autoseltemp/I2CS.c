...
static void I2CS_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    void I2CS_SetPins(uint32 mode, uint32 subMode, uint32 uartEnableMask)
    {
        ...
        {
            I2CS_RX_SDA_MOSI_HSIOM_SEL_GPIO,
            I2CS_TX_SCL_MISO_HSIOM_SEL_GPIO,
            0u,
            0u,
            0u,
            0u,
            ...
            (I2CS_SCB_MODE_EZI2C == mode))
        {
            ...
            hsiomSel[I2CS_RX_SDA_MOSI_PIN_INDEX] = I2CS_RX_SDA_MOSI_HSIOM_SEL_I2C;
            pinsDm  [I2CS_RX_SDA_MOSI_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
        #elif (I2CS_RX_WAKE_SDA_MOSI_PIN)
            hsiomSel[I2CS_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CS_RX_WAKE_SDA_MOSI_HSIOM_SEL_I2C;
            pinsDm  [I2CS_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
        #else
        #endif /* (I2CS_RX_SDA_MOSI_PIN) */
        
        #if (I2CS_TX_SCL_MISO_PIN)
            hsiomSel[I2CS_TX_SCL_MISO_PIN_INDEX] = I2CS_TX_SCL_MISO_HSIOM_SEL_I2C;
            pinsDm  [I2CS_TX_SCL_MISO_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
        ...
        {
        #if (I2CS_RX_SDA_MOSI_PIN)
            hsiomSel[I2CS_RX_SDA_MOSI_PIN_INDEX] = I2CS_RX_SDA_MOSI_HSIOM_SEL_SPI;
        #elif (I2CS_RX_WAKE_SDA_MOSI_PIN)
            hsiomSel[I2CS_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CS_RX_WAKE_SDA_MOSI_HSIOM_SEL_SPI;
        #else
        #endif /* (I2CS_RX_SDA_MOSI_PIN) */
        
        #if (I2CS_TX_SCL_MISO_PIN)
            hsiomSel[I2CS_TX_SCL_MISO_PIN_INDEX] = I2CS_TX_SCL_MISO_HSIOM_SEL_SPI;
        #endif /* (I2CS_TX_SCL_MISO_PIN) */
            ...
            {
                /* Slave */
                pinsDm[I2CS_RX_SDA_MOSI_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
                pinsDm[I2CS_TX_SCL_MISO_PIN_INDEX] = I2CS_PIN_DM_STRONG;
                ...
                /* Disable input buffer */
                 pinsInBuf |= I2CS_TX_SCL_MISO_PIN_MASK;
            #endif /* (I2CS_TX_SCL_MISO_PIN) */
            }
            else 
            {
                /* (Master) */
                pinsDm[I2CS_RX_SDA_MOSI_PIN_INDEX] = I2CS_PIN_DM_STRONG;
                pinsDm[I2CS_TX_SCL_MISO_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
            ...
            #if (I2CS_RX_SDA_MOSI_PIN)
                pinsInBuf |= I2CS_RX_SDA_MOSI_PIN_MASK;
            #elif (I2CS_RX_WAKE_SDA_MOSI_PIN)
                pinsInBuf |= I2CS_RX_WAKE_SDA_MOSI_PIN_MASK;
            #else
            #endif /* (I2CS_RX_SDA_MOSI_PIN) */
        ...
        else /* UART */
        {
            if (I2CS_UART_MODE_SMARTCARD == subMode)
            {
                /* SmartCard */
            #if (I2CS_TX_SCL_MISO_PIN)
                hsiomSel[I2CS_TX_SCL_MISO_PIN_INDEX] = I2CS_TX_SCL_MISO_HSIOM_SEL_UART;
                pinsDm  [I2CS_TX_SCL_MISO_PIN_INDEX] = I2CS_PIN_DM_OD_LO;
            #endif /* (I2CS_TX_SCL_MISO_PIN) */
            }
            else /* Standard or IrDA */
            {
                ...
                {
                #if (I2CS_RX_SDA_MOSI_PIN)
                    hsiomSel[I2CS_RX_SDA_MOSI_PIN_INDEX] = I2CS_RX_SDA_MOSI_HSIOM_SEL_UART;
                    pinsDm  [I2CS_RX_SDA_MOSI_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
                #elif (I2CS_RX_WAKE_SDA_MOSI_PIN)
                    hsiomSel[I2CS_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CS_RX_WAKE_SDA_MOSI_HSIOM_SEL_UART;
                    pinsDm  [I2CS_RX_WAKE_SDA_MOSI_PIN_INDEX] = I2CS_PIN_DM_DIG_HIZ;
                #else
                #endif /* (I2CS_RX_SDA_MOSI_PIN) */
                }
    ...
    /* Note: the DR register settings do not effect the pin output if HSIOM is other than GPIO */
        ...
        I2CS_SET_HSIOM_SEL(I2CS_RX_SDA_MOSI_HSIOM_REG,
                                       ...
                                       I2CS_RX_SDA_MOSI_HSIOM_POS,
                                        hsiomSel[I2CS_RX_SDA_MOSI_PIN_INDEX]);

        I2CS_uart_rx_i2c_sda_spi_mosi_SetDriveMode((uint8) pinsDm[I2CS_RX_SDA_MOSI_PIN_INDEX]);

        #if (!I2CS_CY_SCBIP_V1)
            I2CS_SET_INP_DIS(I2CS_uart_rx_i2c_sda_spi_mosi_INP_DIS,
                                         I2CS_uart_rx_i2c_sda_spi_mosi_MASK,
                                         (0u != (pinsInBuf & I2CS_RX_SDA_MOSI_PIN_MASK)));
        #endif /* (!I2CS_CY_SCBIP_V1) */
        ...
        I2CS_SET_HSIOM_SEL(I2CS_RX_WAKE_SDA_MOSI_HSIOM_REG,
                                       ...
                                       hsiomSel[I2CS_RX_WAKE_SDA_MOSI_PIN_INDEX]);

        I2CS_uart_rx_wake_i2c_sda_spi_mosi_SetDriveMode((uint8)
                                                               pinsDm[I2CS_RX_WAKE_SDA_MOSI_PIN_INDEX]);

        I2CS_SET_INP_DIS(I2CS_uart_rx_wake_i2c_sda_spi_mosi_INP_DIS,
                                     I2CS_uart_rx_wake_i2c_sda_spi_mosi_MASK,
                                     (0u != (pinsInBuf & I2CS_RX_WAKE_SDA_MOSI_PIN_MASK)));

         /* Set interrupt on falling edge */
        I2CS_SET_INCFG_TYPE(I2CS_RX_WAKE_SDA_MOSI_INTCFG_REG,
                                        I2CS_RX_WAKE_SDA_MOSI_INTCFG_TYPE_MASK,
    ...
    #if (I2CS_TX_SCL_MISO_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_TX_SCL_MISO_HSIOM_REG,
                                       I2CS_TX_SCL_MISO_HSIOM_MASK,
                                       I2CS_TX_SCL_MISO_HSIOM_POS,
                                        hsiomSel[I2CS_TX_SCL_MISO_PIN_INDEX]);

        I2CS_uart_tx_i2c_scl_spi_miso_SetDriveMode((uint8) pinsDm[I2CS_TX_SCL_MISO_PIN_INDEX]);

    #if (!I2CS_CY_SCBIP_V1)
        I2CS_SET_INP_DIS(I2CS_uart_tx_i2c_scl_spi_miso_INP_DIS,
                                     I2CS_uart_tx_i2c_scl_spi_miso_MASK,
                                    (0u != (pinsInBuf & I2CS_TX_SCL_MISO_PIN_MASK)));
    #endif /* (!I2CS_CY_SCBIP_V1) */
    #endif /* (I2CS_RX_SDA_MOSI_PIN) */
