// ======================================================================
// Beast.v generated from TopDesign.cysch
// 11/02/2016 at 15:26
...
module top ;
	...
	cy_psoc3_pins_v1_10
		#(.id("d1694ba1-8bda-46cb-8ea3-735624df6087"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("5f345921-f49b-4303-9287-f502e53911b6"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
	...
	cy_psoc3_pins_v1_10
		#(.id("d18e2a31-4493-44fd-9fc0-b951a0895b3e"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
    ...
    PWM_v3_30_1 PWM_DRIFT (
        ...
        .ph1(Net_94),
        .ph2(Net_95));
    defparam PWM_DRIFT.Resolution = 8;


	cy_clock_v1_0
		#(.id("c5385727-b028-4015-a788-08068b1467bd"),
		  .source_clock_id(""),
		  .divisor(0),
		  .period("20000000000"),
		  .is_direct(0),
	...
	wire [0:0] tmpOE__Pin_PWM_FRONT_net;
	wire [0:0] tmpFB_0__Pin_PWM_FRONT_net;
	wire [0:0] tmpIO_0__Pin_PWM_FRONT_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PWM_FRONT_net;
	electrical [0:0] tmpSIOVREF__Pin_PWM_FRONT_net;

	cy_psoc3_pins_v1_10
		#(.id("1f9c0732-5278-4482-9e11-694d8c4b3ba3"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PWM_FRONT
		 (.oe(tmpOE__Pin_PWM_FRONT_net),
		  .y({Net_96}),
		  .fb({tmpFB_0__Pin_PWM_FRONT_net[0:0]}),
		  .io({tmpIO_0__Pin_PWM_FRONT_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PWM_FRONT_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PWM_FRONT_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PWM_FRONT_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Pin_PWM_BACK_net;
	wire [0:0] tmpFB_0__Pin_PWM_BACK_net;
	wire [0:0] tmpIO_0__Pin_PWM_BACK_net;
	wire [0:0] tmpINTERRUPT_0__Pin_PWM_BACK_net;
	electrical [0:0] tmpSIOVREF__Pin_PWM_BACK_net;

	cy_psoc3_pins_v1_10
		#(.id("da6ba5a0-e975-42d6-9992-76bd495770dd"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Pin_PWM_BACK
		 (.oe(tmpOE__Pin_PWM_BACK_net),
		  .y({Net_155}),
		  .fb({tmpFB_0__Pin_PWM_BACK_net[0:0]}),
		  .io({tmpIO_0__Pin_PWM_BACK_net[0:0]}),
		  .siovref(tmpSIOVREF__Pin_PWM_BACK_net),
		  .interrupt({tmpINTERRUPT_0__Pin_PWM_BACK_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Pin_PWM_BACK_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
