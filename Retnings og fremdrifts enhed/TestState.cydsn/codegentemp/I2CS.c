...
static void I2CS_ScbModeStop(void)
{
    ...
    *******************************************************************************/
    ...
    #if (I2CS_SCLK_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_SCLK_HSIOM_REG,
                                       I2CS_SCLK_HSIOM_MASK,
                                       I2CS_SCLK_HSIOM_POS,
                                       hsiomSel[I2CS_SCLK_PIN_INDEX]);

        I2CS_spi_sclk_SetDriveMode((uint8) pinsDm[I2CS_SCLK_PIN_INDEX]);

        I2CS_SET_INP_DIS(I2CS_spi_sclk_INP_DIS,
                                     I2CS_spi_sclk_MASK,
                                     (0u != (pinsInBuf & I2CS_SCLK_PIN_MASK)));
    #endif /* (I2CS_SCLK_PIN) */

    #if (I2CS_SS0_PIN)
        I2CS_SET_HSIOM_SEL(I2CS_SS0_HSIOM_REG,
                                       I2CS_SS0_HSIOM_MASK,
                                       I2CS_SS0_HSIOM_POS,
                                       hsiomSel[I2CS_SS0_PIN_INDEX]);

        I2CS_spi_ss0_SetDriveMode((uint8) pinsDm[I2CS_SS0_PIN_INDEX]);

        I2CS_SET_INP_DIS(I2CS_spi_ss0_INP_DIS,
                                     I2CS_spi_ss0_MASK,
                                     (0u != (pinsInBuf & I2CS_SS0_PIN_MASK)));
    #endif /* (I2CS_SS0_PIN) */
