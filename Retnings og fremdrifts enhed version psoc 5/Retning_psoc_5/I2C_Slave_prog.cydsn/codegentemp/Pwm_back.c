...
{
    uint8 staticBits = (Pwm_back_DR & (uint8)(~Pwm_back_MASK));
    Pwm_back_DR = staticBits | ((uint8)(value << Pwm_back_SHIFT) & Pwm_back_MASK);
}
...
{
	CyPins_SetPinDriveMode(Pwm_back_0, mode);
}
...
{
    return (Pwm_back_PS & Pwm_back_MASK) >> Pwm_back_SHIFT;
}
...
{
    return (Pwm_back_DR & Pwm_back_MASK) >> Pwm_back_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(Pwm_back_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & Pwm_back_0_INTR) != 0u) 
		{ 
			 Pwm_back_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (Pwm_back_INTSTAT & Pwm_back_MASK) >> Pwm_back_SHIFT;
    }
