...
**************************************/
#define PWM1_INIT_PERIOD_VALUE          (1u)
#define PWM1_INIT_COMPARE_VALUE1        (1u)
#define PWM1_INIT_COMPARE_VALUE2        (1u)
...
#define PWM1_DEFAULT_COMPARE2_MODE      (uint8)((uint8)3u <<  PWM1_CTRL_CMPMODE2_SHIFT)
