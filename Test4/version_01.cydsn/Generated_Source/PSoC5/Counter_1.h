...
#define Counter_1_INIT_PERIOD_VALUE       200u
#define Counter_1_INIT_COUNTER_VALUE      200u
#if (Counter_1_UsingFixedFunction)
#define Counter_1_INIT_INTERRUPTS_MASK    ((uint8)((uint8)0u << Counter_1_STATUS_ZERO_INT_EN_MASK_SHIFT))
#else
#define Counter_1_INIT_COMPARE_VALUE      100u
#define Counter_1_INIT_INTERRUPTS_MASK ((uint8)((uint8)0u << Counter_1_STATUS_ZERO_INT_EN_MASK_SHIFT) | \
...
#define Counter_1_DEFAULT_COMPARE_MODE    2u
