...
*
* \funcusage
*  \snippet Dir_SUT.c usage_Dir_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Dir_SUT.c usage_Dir_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Dir_SUT.c usage_Dir_Read  
*******************************************************************************/
uint8 Dir_Read(void)
{
...
* preferred Dir_Read() API because the 
* Dir_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Dir_SUT.c usage_Dir_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Dir_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Dir_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Dir_0_INTR       (First pin in the list)
    *  - Dir_1_INTR       (Second pin in the list)
    *  - ...
    *  - Dir_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Dir_SUT.c usage_Dir_SetInterruptMode
    *******************************************************************************/
    void Dir_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Dir_0_INTR) != 0u) 
		{ 
			 Dir_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Dir_SUT.c usage_Dir_ClearInterrupt
    *******************************************************************************/
