...
**************************************/
#define PWM2_INIT_PERIOD_VALUE          (1u)
#define PWM2_INIT_COMPARE_VALUE1        (1u)
#define PWM2_INIT_COMPARE_VALUE2        (1u)
...
#define PWM2_DEFAULT_COMPARE2_MODE      (uint8)((uint8)3u <<  PWM2_CTRL_CMPMODE2_SHIFT)
