...
// QuadDec_v3_0(Counter8bit=true, CounterResolution=1, CounterSize=8, CounterSizeReplacementString=int8, CounterSizeReplacementStringUnsigned=uint8, TypeCastReplacementString=int16, UsingGlitchFiltering=true, UsingIndexInput=false, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMPONENT_NAME=QuadDec_v3_0, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=UpDown, CY_INSTANCE_SHORT_NAME=UpDown, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=0, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.0, INSTANCE_NAME=UpDown, )
...
module top ;
    ...
    assign Net_453 = Net_460 & Net_399;
    ...
    assign Net_452 = Net_276 & Net_466;
    ...
    assign Net_345 = Net_452 | Net_453;
    ...
    assign Net_460 = ~Net_466;

    QuadDec_v3_0_3 UpDown (
        .quad_A(Net_276),
        .quad_B(Net_399),
        .index(1'b0),
        .clock(Net_440),
        .interrupt(Net_441));
    defparam UpDown.CounterResolution = 1;
    defparam UpDown.UsingGlitchFiltering = 1;
    defparam UpDown.UsingIndexInput = 0;

	wire [0:0] tmpOE__set_pwm_net;
	wire [0:0] tmpIO_0__set_pwm_net;
	wire [0:0] tmpINTERRUPT_0__set_pwm_net;
	electrical [0:0] tmpSIOVREF__set_pwm_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		set_pwm
		 (.oe(tmpOE__set_pwm_net),
		  .y({1'b0}),
		  .fb({Net_466}),
		  .io({tmpIO_0__set_pwm_net[0:0]}),
		  .siovref(tmpSIOVREF__set_pwm_net),
		  .interrupt({tmpINTERRUPT_0__set_pwm_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__set_pwm_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
